      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              showSearch(context: context, delegate: VideoSearch(videos));
            },
          ),
        ],
      ),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      maxLines: 2, // Adjust max lines for title
...
class VideoSearch extends SearchDelegate<String> {
  ...
  Widget buildResults(BuildContext context) {
    final filteredVideos = videos.where((video) => video.title.toLowerCase().contains(query.toLowerCase())).toList();
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => VideoPlayer1()));
          },
          child: Card(
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(15.0),
